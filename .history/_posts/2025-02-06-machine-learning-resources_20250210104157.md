...
- **Ensemble methods**: Ensemble methods are a technique used to combine the predictions from different models (e.g., Random Forest, Gradient Boosting). This technique allows to reduce variance without increasing bias too much
