...
- **Regularization**: Regularization is a technique used to prevent overfitting by adding a penalty to the model parameters. Classical examples of regularisation in 
