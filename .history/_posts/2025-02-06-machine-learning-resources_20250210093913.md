...
- **Bias**: In machine learning in general, bias refers to a systematic error introduced Bias is a systematic error in a machine learning model that causes it to produce results
