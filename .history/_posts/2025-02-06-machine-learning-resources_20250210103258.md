...
- **Bias-Variance tradeoff**. This is a fundamental concept in machine learning when we try to balance two competing factors: *bais* and *variance*. 
    ...
    * **High Bias, low variance**. The model is simple and makes strong assumptions. it doesn't capture much complexity, leading to underffiting. The prediction is often 
