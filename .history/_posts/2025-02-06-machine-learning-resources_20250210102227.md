...
- **Variance**: Variance referes to how much the model's predictions change when trained on different subsets of data. 
    ...
    * **Low variance**: A models with low variance doesn't change much when trained on different subsets of data. It tends the make stable prdictions, bay may struggle to capture complex patterns
